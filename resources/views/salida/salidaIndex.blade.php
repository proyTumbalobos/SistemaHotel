    ...
    <div class="list-group">
        <div href="#" class="list-group-item list-group-item-action flex-column align-items-start active">
          <div class="d-flex w-100 justify-content-between">
            <h5 class="mb-1">Habitaciones ocupadas</h5>
          </div>
        </div>
        <div href="#" class="list-group-item list-group-item-action flex-column align-items-start">
          ...
          <div class="d-flex flex-wrap w-100 justify-content-around">
            ...
            <div class="card border-warning mb-3" style="max-width: 20rem;">
                ...
                <form id="form-{{ $item->id }}" action="{{ route('salida.update',$item->id) }}" method="POST">
                  @csrf
                  @method('put')

                  </form>
                <button form="form-{{ $item->id }}" class="btn btn-outline-warning m-1" type="submit">Marcar Salida</button>
              </div>
              @endforeach 
